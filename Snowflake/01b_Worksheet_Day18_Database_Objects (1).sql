...
CREATE OR REPLACE TRANSIENT TABLE SUPPLIERS AS
SELECT S_SUPPKEY,
       S_NAME,
       S_NATIONKEY
FROM SNOWFLAKE_SAMPLE_DATA.TPCH_SF1.SUPPLIER;

SHOW TABLES IN SCHEMA MY_DB.CURATED;

SELECT COUNT(*) AS supplier_rows
FROM SUPPLIERS;

-- I would choose a TRANSIENT table for temporary staging or intermediate data that can be recreated and does not need Fail-safe protection.
